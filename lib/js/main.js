...
class Tab{
    constructor(button, div, main) { //button is a button element, div is the div related to the button, and main is a boolean for whether its a main tab
        this.button = button;
        this.div = div;
        this.main = main;
        this.hide();
