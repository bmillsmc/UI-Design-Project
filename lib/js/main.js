            ...
            for(let j = 1; j <= infoList.length; j++) {
                fetch(url + urlEnd + "/"+j)
                    ...
                    .then(res => {
                        ...
                        if(charDatTabs[i].childNodes.length <= divLengths[i] && charDatTabs[i].classList.contains("abil-sco-tab")){
                            setTimeout(() => {
                                console.dir(res);
                        ...
                        } else if(charDatTabs[i].childNodes.length <= divLengths[i] && charDatTabs[i].classList.contains("skill-tab")) {
                            setTimeout(() => {
                                console.dir(res);
                            }, 100 + (j*100));
                        } else if(charDatTabs[i].childNodes.length <= divLengths[i] && charDatTabs[i].classList.contains("prof-tab")) {
                            setTimeout(() => {
                                console.dir(res);
                            }, 100 + (j*100));
                        } else if(charDatTabs[i].childNodes.length <= divLengths[i] && charDatTabs[i].classList.contains("lang-tab")) {
                            setTimeout(() => {
                                console.dir(res);
                            }, 100 + (j*100));
                        } else {
