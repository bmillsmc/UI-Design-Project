...
class Tab{
    constructor(button, div, main, tabs) { //button is a button element, div is the div related to the button, main is a boolean for whether its a main tab, and initilizes tabArray
        this.button = button;
        this.div = div;
        this.tabs = tabs;
        this.main = main;
